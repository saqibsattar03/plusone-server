...
export class VoucherService {
  ...
  // async createVoucher(voucherDto: CreateVoucherDto): Promise<any> {
  ...
  async getAllVouchersByRestaurant(
    restaurantId,
    voucherPreference,
  ): Promise<any> {
    ...
    return this.voucherModel.aggregate([
      ...
      { $unwind: '$voucherObject' },
      { $match: { 'voucherObject.voucherPreference': voucherPreference } },
    ]);
  }
  ...
  async redeemVoucher(
    ...
    console.log('verification code = ', restaurant);
